...
-- Diagnostic keymaps
vim.keymap.set('n', '<F2>', vim.diagnostic.goto_prev, { desc = 'Go to previous diagnostic message' })
vim.keymap.set('n', '<Shift><F2>', vim.diagnostic.goto_next, { desc = 'Go to next diagnostic message' })
